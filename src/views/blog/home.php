            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/older_posts/older_posts_3.jpg" alt="" class="w-100 img-fluid">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/older_posts/older_posts_1.jpg" alt="" class="w-100 img-fluid">
                        <div class="card-header position-absolute bottom-0 pt-4">
                            <a href="#" class="text-dark">
                                <h2 class="text-shadow h6 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                    Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/older_posts/older_posts_2.jpg" alt="" class="w-100 img-fluid">
                        <div class="card-header position-absolute bottom-0 pt-4">
                            <a href="#" class="text-dark">
                                <h2 class="text-shadow h6 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                    Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/trending/trending_3.jpg" alt="" class="w-100 img-fluid">
                        <div class="card-header position-absolute bottom-0 pt-4">
                            <a href="#" class="text-dark">
                                <h2 class="text-shadow h6 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                    Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/trending/trending_4.jpg" alt="" class="w-100 img-fluid">
                        <div class="card-header position-absolute bottom-0 pt-4">
                            <a href="#" class="text-dark">
                                <h2 class="text-shadow h6 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                    Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-2">
                    <div class="card position-relative overflow-hidden">
                        <img src="/assets/img/trending/trending_5.jpg" alt="" class="w-100 img-fluid">
                        <div class="card-header position-absolute bottom-0 pt-4">
                            <a href="#" class="text-dark">
                                <h2 class="text-shadow h6 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                    Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
    ...
    <section class="section border-bottom border-top border-3 border-danger">
        <div class="row mb-3">
            <div class="col-12 col-md-6 col-sm-12">
                ...
                <div class="card position-relative overflow-hidden">
                    <img src="/assets/img/older_posts/older_posts_4.jpg" alt="" class="w-100 img-fluid">
                    <div class="card-header position-absolute bottom-0 pt-4">
                        <a href="#" class="text-dark">
            ...
            <div class="col-12 col-md-6 col-sm-12">
                ...
                <div class="card position-relative overflow-hidden">
                    <img src="/assets/img/older_posts/older_posts_5.jpg" alt="" class="w-100 img-fluid">
                    <div class="card-header position-absolute bottom-0 pt-4">
                        <a href="#" class="text-dark">
                            <h2 class="text-shadow h1 text-capitalize border-bottom border-3 border-danger pb-2 text-white text-start">
                                Twitter's New Retweet With Comment Counter Is Now Available On Andriod & Web</h2>
